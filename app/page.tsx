      ...
      <main>
          ...
          <section className="bg-background py-16 lg:py-28 2xl:py-32">
            <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="display-heading mt-5 text-[30px] text-ink sm:text-[42px] lg:text-[52px] 2xl:text-[56px] dark:text-foreground">
          ...
          <section className="surface-paper py-16 lg:py-28 2xl:py-32">
            <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
              <div className="grid gap-8 lg:grid-cols-[1fr_0.75fr] lg:items-end">
                ...
                <p className="text-[15px] lg:text-[17px] 2xl:text-[20px] leading-[1.7] text-ink-soft lg:pb-3 dark:text-foreground/70">
              ...
              <div className="mt-14">
                <Rail>
                  {favourites.map((product) => (
                    <div key={product._id} className="w-[290px] shrink-0 snap-start sm:w-[320px] 2xl:w-[356px]">
                      <ProductCard
                        product={product}
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
            <div className="relative overflow-hidden rounded-[4px] bg-ink">
              ...
              <div className="relative max-w-2xl px-6 py-16 sm:px-12 lg:px-16 lg:py-28 2xl:py-32">
                ...
                <p className="mt-5 max-w-lg text-[15px] lg:text-[17px] 2xl:text-[20px] leading-[1.7] text-white/85">
                  From family favorites to generous biryani and pulav portions, make your next meal something everyone
                  can enjoy.
                </p>
                <Link
                  href="/categories"
                  className="mt-9 inline-flex items-center gap-3 rounded-full bg-white px-8 py-4 2xl:px-12 2xl:py-5 2xl:leading-[1.2] text-[15px] lg:text-[17px] 2xl:text-[23px] text-ink transition-colors hover:bg-brand hover:text-white"
                >
        ...
        <section className="surface-paper py-16 lg:py-28 2xl:py-32">
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="display-heading mt-5 max-w-4xl text-[30px] text-ink sm:text-[42px] lg:text-[52px] 2xl:text-[56px] dark:text-foreground">
                From breakfast to dinner, there's something for everyone.
              </h2>
              <p className="mt-5 max-w-xl text-[15px] lg:text-[17px] 2xl:text-[20px] leading-[1.7] text-ink-soft dark:text-foreground/70">
                A selection of flavorful favorites made for sharing, enjoying, and coming back for.
              </p>
            </div>
          ...
          <section className="bg-background py-16 lg:py-28 2xl:py-32">
            <div className="mx-auto grid max-w-[1600px] items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-20 lg:px-10">
              ...
              <div>
                ...
                <h2 className="display-heading mt-5 text-[30px] text-ink sm:text-[40px] lg:text-[50px] 2xl:text-[54px] dark:text-foreground">
                  {spotlight.name}
                </h2>
                <p className="mt-5 max-w-xl text-[15px] lg:text-[17px] 2xl:text-[20px] leading-[1.7] text-ink-soft dark:text-foreground/70">
                ...
                <ul className="mt-9">
                  {spotlightProducts.map((product) => (
                    <li key={product._id} className="border-b border-line/80 dark:border-border">
                      ...
                      >
                        <span className="font-display text-[20px] font-semibold uppercase tracking-wide text-ink sm:text-[23px] 2xl:text-[27px] dark:text-foreground">
                          {product.name}
                        </span>
                ...
                <Link
                  ...
                  className="mt-10 inline-block rounded-full bg-brand px-9 py-4 2xl:px-12 2xl:py-5 2xl:leading-[1.2] text-[15px] lg:text-[17px] 2xl:text-[23px] text-white transition-colors hover:bg-brand-dark"
                >
                  ...
                  <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                    {secondaryProducts.map((product) => (
                      <Link
                        key={product._id}
                        href={`/product/${product._id}`}
                        className="rounded-full border border-white/60 px-7 py-3.5 2xl:px-12 2xl:py-5 2xl:leading-[1.2] text-[15px] lg:text-[17px] 2xl:text-[23px] text-white transition-colors hover:border-white hover:bg-white hover:text-ink"
                      >
                        {product.name}
                      </Link>
                    ))}
        ...
        <section className="bg-background pb-16 lg:pb-28 2xl:pb-32">
          <div className="mx-auto grid max-w-[1600px] items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-20 lg:px-10">
            <div>
              ...
              <h2 className="display-heading mt-5 text-[30px] text-ink sm:text-[40px] lg:text-[48px] 2xl:text-[52px] dark:text-foreground">
              ...
              <Link
                href="/about"
                className="mt-9 inline-block rounded-full bg-brand px-9 py-4 2xl:px-12 2xl:py-5 2xl:leading-[1.2] text-[15px] lg:text-[17px] 2xl:text-[23px] text-white transition-colors hover:bg-brand-dark"
              >
                Read Our Story
              </Link>
            </div>
        ...
        <section className="surface-paper py-16 lg:py-28 2xl:py-32">
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="display-heading mt-5 text-[30px] text-ink sm:text-[42px] lg:text-[50px] 2xl:text-[54px] dark:text-foreground">
        ...
        <section className="bg-background py-16 lg:py-28 2xl:py-32">
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
            ...
            {/* Carousel, as in the design: three reviews fill a wide screen, and
                the arrows take over once the row no longer fits. */}
            <div className="mt-14">
              <Rail controls="below">
                {TESTIMONIALS.map((testimonial) => (
                  <article
                    key={testimonial.name}
                    className="flex w-[300px] shrink-0 snap-start flex-col border border-line/80 bg-card p-7 sm:w-[360px] lg:w-[420px] 2xl:w-[485px] 2xl:p-10 dark:border-border"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <h3 className="font-display text-[22px] font-semibold text-ink 2xl:text-[24px] dark:text-foreground">
                        — {testimonial.name}
                      </h3>
                    ...
                    <p className="mt-5 flex-1 text-[15px] lg:text-[17px] 2xl:text-[20px] leading-[1.75] text-ink-soft/80 dark:text-foreground/70">
                      “{testimonial.quote}”
                    </p>
                    <div className="mt-7 h-px w-full bg-line dark:bg-border" />
                    <div className="mt-5 flex items-center justify-end gap-3">
                      <span className="font-display text-[19px] font-semibold text-ink 2xl:text-[21px] dark:text-foreground">
                        Google Reviews
                      </span>
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
            <div className="relative overflow-hidden rounded-[4px] bg-ink">
              ...
              <div className="relative flex flex-col items-center px-6 py-16 text-center sm:px-12 lg:py-28 2xl:py-32">
                ...
                <Link
                  href="/categories"
                  className="mt-9 inline-flex items-center gap-3 rounded-full bg-brand px-9 py-4 2xl:px-12 2xl:py-5 2xl:leading-[1.2] text-[15px] lg:text-[17px] 2xl:text-[23px] text-white transition-colors hover:bg-brand-dark"
                >
                  Start Your Order
