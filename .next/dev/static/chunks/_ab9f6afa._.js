...
function useAuth() {
    ...
    const login = async (phone, storeOverride)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.login(phone, store);
            return true;
        } catch (err) {
...
function useStore() {
    ...
    const selectStore = async (slug)=>{
        try {
            setIsLoading(true);
            setError(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setActiveStoreSlug"])(slug);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].store.getBySubdomain(slug);
            const storeData = response.data || response;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setActiveStore"])(storeData);
            setStoreState(storeData);
...
//# sourceMappingURL=_ab9f6afa._.js.map